...
export const chunkDBQueryIDsInOperator = (
    ids: string[],
): { chunkedExpressionAttributeValues: { [key: string]: any }; chunkedFilterExpression: string } => {
    ...
    return { chunkedExpressionAttributeValues, chunkedFilterExpression: filterExpression.join(' OR ') };
};
